...
class AppointmentReadyDailog extends StatefulWidget {
  ...
  @override
  State<AppointmentReadyDailog> createState() => _AppointmentReadyDailogState();
}

class _AppointmentReadyDailogState extends State<AppointmentReadyDailog> {
  @override
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: .start,
                  children: [
                    Text("Treatment Notes", style: CustomFonts.black22w600),
                    SizedBox(height: 20.h),
                    Row(
                      children: [
